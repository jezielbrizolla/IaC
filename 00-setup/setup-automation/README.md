# setup-automation — orquestrador do Bloco 0

Automatiza o que o `00-setup/README.md` pede manualmente: instala/valida
Terraform, Packer e Docker Desktop, confere WSL2+Ubuntu, a extensão do VS
Code, o repositório git e a autenticação SSH com o GitHub — tudo logado em
console (colorido) e em arquivo.

É o próprio tema do projeto aplicado a ele mesmo: se o resto do Track 0 é
sobre automatizar infraestrutura, o setup do laboratório também devia ser
automatizado.

## Rodar

Abra o **PowerShell como Administrador** (Hyper-V e alguns `winget install`
exigem elevação) e rode:

```powershell
cd labs\00-setup\setup-automation
.\setup.ps1
```
