# Marca itens do 00-setup/CHECKLIST.md como [x] com base no que o orquestrador
# validou de fato nesta execucao. Nunca desmarca um item ja marcado manualmente.
...
function Update-SetupChecklist {
    ...
    # Pattern (regex, aplicado a linha do checklist) -> Name do resultado que precisa estar OK
    $map = @(
